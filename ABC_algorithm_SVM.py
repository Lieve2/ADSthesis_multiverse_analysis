...
class ArtificialBee(object):
    ...
    def __init__(self, l_bound, u_bound, function):
        ...
        # compute fitness
        if function is not None and isinstance(function, pipeline_SVM.OptRFParameters):
            self.fitness_val = function.objective_function_value(self.sol_vector)[0][0]
        elif function is not None and not isinstance(function, pipeline_SVM.OptRFParameters):
