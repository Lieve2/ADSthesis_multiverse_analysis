...
from utility_functions import encode_scale_data_perm_mi
...
def processing_pipeline_RF(data, targets, threshold, filename, num_feat):
    ...
    for target in targets:
        ...
        X, y, features, clusters = encode_scale_data_perm_mi(data, target, threshold, num_feat)
...
processing_pipeline_RF(data=data, targets=targets, num_feat=num_feat, threshold=1, filename='RF_mi')
