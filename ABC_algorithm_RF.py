...
class ArtificialBee(object):
    ...
    def __init__(self, l_bound, u_bound, function):
        ...
        # compute fitness
        if (function != None and isinstance(function, parameter_search_RF_changedCV.OptRFParameters)):
            self.fitness_val = function.objective_function_value(self.sol_vector)[0][0]
        elif (function != None and not isinstance(function, parameter_search_RF_changedCV.OptRFParameters)):
